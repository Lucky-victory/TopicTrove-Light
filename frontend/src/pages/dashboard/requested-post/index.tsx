...
const allPostRequests = [
  {
    ...
    title: "Understanding Humans psychology, philosophy and Physiology",
    request:
      "I want you to write about me because i love games and i can dance",
    stake: 5,
    recievedTips: 10,
    status: "pending",
  },
...
const RequestedPost = () => {
  ...
  const [usersRequests, setUsersRequests] = useState(allUsersRequests);
  const [postRequests, setPostsRequets] = useState(allPostRequests);
                ...
                >
                  ...
                  >
                    ...
                    <Button background={"white"}>
                      ...
                      >
                        <path
                          d="M13.9997 21.6277C13.6785 21.6277 13.4039 21.5137 13.176 21.2858C12.9481 21.0579 12.8338 20.783 12.833 20.461C12.833 20.1406 12.9473 19.866 13.176 19.6373C13.4047 19.4087 13.6792 19.2943 13.9997 19.2943C14.3209 19.2943 14.5955 19.4087 14.8233 19.6373C15.0512 19.866 15.1656 20.1406 15.1663 20.461C15.1663 20.7822 15.052 21.0572 14.8233 21.2858C14.5947 21.5145 14.3201 21.6284 13.9997 21.6277ZM13.9997 15.1667C13.6785 15.1667 13.4039 15.0523 13.176 14.8237C12.9481 14.595 12.8338 14.3204 12.833 14C12.833 13.6788 12.9473 13.4042 13.176 13.1763C13.4047 12.9484 13.6792 12.8341 13.9997 12.8333C14.3209 12.8333 14.5955 12.9477 14.8233 13.1763C15.0512 13.405 15.1656 13.6796 15.1663 14C15.1663 14.3212 15.052 14.5958 14.8233 14.8237C14.5947 15.0516 14.3201 15.1659 13.9997 15.1667ZM13.9997 8.70567C13.6785 8.70567 13.4039 8.59133 13.176 8.36267C12.9481 8.134 12.8338 7.85944 12.833 7.539C12.833 7.21778 12.9473 6.94283 13.176 6.71417C13.4047 6.4855 13.6792 6.37156 13.9997 6.37233C14.3209 6.37233 14.5955 6.48628 14.8233 6.71417C15.0512 6.94206 15.1656 7.217 15.1663 7.539C15.1663 7.85944 15.052 8.134 14.8233 8.36267C14.5947 8.59133 14.3201 8.70567 13.9997 8.70567Z"
                          fill="#525559"
                        />
                      </svg>
                    </Button>
